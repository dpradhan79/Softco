...
{	
	...
	public static String TEST_DATA_LOCATIOn = "testdata";
	...
	/* Config info work sheet name in excel */ 
	public static String CONFIG_SHEET_NAME = "Config";
	
	/* UI Properties File Name */
	public static String LOCATORSFILENAME = "WEB-UI.properties";
