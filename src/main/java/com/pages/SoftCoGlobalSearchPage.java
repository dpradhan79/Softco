...
public class SoftCoGlobalSearchPage extends PageTemplate {
	...
	protected boolean expandARInvoice() throws Exception
	{
		boolean isSuccess = false;
		try
		{
	...
	protected boolean expandARProcessingQueue() throws Exception
	{
		boolean isSuccess = false;
		try
		{
	...
	protected boolean expandARGlobalSearch() throws Exception
	{
		boolean isSuccess = false;
		try
		{
